...
// NUEVA VERSIÓN CON PROXY FUNCIONAL
...
function applyFilters() {
  ...
  setTimeout(() => {
    ...
    const filteredGames = allGames.filter(game =>{
      if (titleValue && !game.title.toLowerCase().includes(titleValue)) return false;
      if (platformValue && !game.platform.includes(platformValue)) return false;
      if (genreValue && game.genre !== genreValue) return false;
